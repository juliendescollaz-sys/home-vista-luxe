                      ...
                      return (
                        <div className="absolute inset-0 z-30 pointer-events-none">
                          {polygons.map((polygon, index) => {
                            ...
                            // Centroïde pour position de base
                            ...
                            // Essayer de retrouver la pièce HA :
                            ...
                            // ID utilisé pour la sélection / sidebar (préférence ID HA)
            ...
            {selectedArea && (
              <>
                ...
                <div className="flex-1 overflow-y-auto p-4">
                  {/* On passe bien l'ID HA ici */}
                  <RoomDevicesGrid areaId={selectedArea.area_id} singleColumn enableDragAndDrop />
                </div>
              </>
            )}
          </div>
        ...
        <div className="space-y-4">
          {selectedAreaId ? (
            <>
              ...
              {/* Liste des appareils de la pièce */}
...
const Rooms = () => {
  ...
  // Plans considérés "utilisables" dès qu'il y en a au moins un
  const hasUsablePlans =
    displayMode !== "mobile" &&
    neoliaFloorPlans.length > 0;

  // Charger les plans au démarrage (sauf en mode mobile)
  useEffect(() => {
