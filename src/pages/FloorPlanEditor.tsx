...
const FloorPlanEditor = () => {
  ...
  // Wrapper canvas uniquement pour tablet/panel, pas pour mobile
  const useCanvasWrapper = displayMode === "tablet" || displayMode === "panel";
  ...
  return (
    <div className={`min-h-screen bg-background ${ptClass}`}>
      ...
      {useCanvasWrapper ? (
        <NeoliaCanvasWrapper className="mx-4 my-4">
          {content}
        </NeoliaCanvasWrapper>
      ) : (
