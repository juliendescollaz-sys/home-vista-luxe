...
interface SceneIconStepProps {
  draft: SceneWizardDraft;
  onUpdate: (updates: Partial<SceneWizardDraft>) => void;
}

export function SceneIconStep({ draft, onUpdate }: SceneIconStepProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg bg-muted/50">
        <p className="text-sm text-muted-foreground">
          ...
          votre scène d'un coup d'œil. L'IA peut vous suggérer une icône adaptée au nom de votre scène.
        </p>
      </div>
