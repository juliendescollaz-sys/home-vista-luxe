...
import { GROUP_ICON_CATEGORIES, GROUP_ICON_FRENCH_LABELS } from "@/types/groups";
...
export function GroupIconPickerDialog({
  ...
  const filteredCategories = useMemo(() => {
    ...
    for (const [key, category] of Object.entries(GROUP_ICON_CATEGORIES)) {
      const matchingIcons = category.icons.filter((icon) => {
        // Check French labels first
        const frenchLabels = GROUP_ICON_FRENCH_LABELS[icon] || [];
