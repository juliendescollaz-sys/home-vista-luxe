      ...
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-[500px] max-h-[85vh] flex flex-col glass-card border-border/50">
          ...
          <div className="flex-1 overflow-y-auto pr-1 space-y-6 py-4">
            ...
            <div className="space-y-3"><Label>Portée du groupe</Label><RadioGroup value={scope} onValueChange={(v) => setScope(v as GroupScope)} className="space-y-2"><div className="flex items-start gap-3 p-3 rounded-md bg-background/30 border border-border/50 hover:bg-accent/30 transition-colors"><RadioGroupItem value="local" id="scope-local" className="mt-0.5" /><label htmlFor="scope-local" className="flex-1 cursor-pointer"><div className="flex items-center gap-2"><User className="h-4 w-4 text-muted-foreground" /><span className="font-medium text-sm">Local</span></div><p className="text-xs text-muted-foreground mt-1">Seulement dans cette app, sur cet appareil</p></label></div><div className="flex items-start gap-3 p-3 rounded-md bg-background/30 border border-border/50 hover:bg-accent/30 transition-colors"><RadioGroupItem value="shared" id="scope-shared" className="mt-0.5" /><label htmlFor="scope-shared" className="flex-1 cursor-pointer"><div className="flex items-center gap-2"><Users className="h-4 w-4 text-primary/70" /><span className="font-medium text-sm">Partagé</span></div><p className="text-xs text-muted-foreground mt-1">Disponible pour tous les utilisateurs</p></label></div></RadioGroup></div>
